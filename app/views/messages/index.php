...
<div class="input-group mb-3">
  ...
  <input type="hidden" name="c_id_fk" value="<?php if(isset($_GET['c_id'])) { echo $_GET['c_id']; }  ?>">
  <div class="input-group-append">
    <button class="btn btn-outline-warning" name="message" value="new" type="input" id="button-addon2">Отправить</button>
  </div>
</div>
</form>
